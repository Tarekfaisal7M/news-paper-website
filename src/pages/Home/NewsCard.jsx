...
const NewsCard = ({ news }) => {
  ...
  return (
    <div className="flex flex-col max-w-lg p-6 space-y-6 overflow-hidden rounded-lg shadow-md dark:bg-gray-50 dark:text-gray-800 mb-16 border-b-2">
      ...
      <div>
        ...
        <h2 className="text-sm dark:text-gray-600">
          {details.length > 200 ? (
            <p>
              {details.slice(0, 200)}{" "}
